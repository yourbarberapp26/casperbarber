    ...
    <div className="app">
      ...
      <header className="hero">
        ...
        <div className="hero__brand">
          <img src={LOGO} alt="Casper – Master Barber" className="hero__logo" />
          <div>
            <h1>Casper</h1>
      ...
      <main className="layout">
        ...
        <section className="card" id="booking">
          ...
          <p className="section-sub">
            Pick your service, choose an open slot, and confirm. Changes allowed up to 1 hour before · 24-hour cancellation policy.
          </p>
  ...
  >
    ...
    <p>{formatMoney(service.price)}</p>
      ...
      <footer className="footer">
        <p><strong>Casper</strong> · 442 Ridge Rd, Lyndhurst, NJ 07071 · <a href="tel:2018896440">(201) 889-6440</a></p>
